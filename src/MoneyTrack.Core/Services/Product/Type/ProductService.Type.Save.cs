...
namespace MoneyTrack.Core.Services
{
    ...
    {
        public async Task<ServiceModelResult<SaveResponse>> SaveAsync(int id, ProductTypeRequest model)
        {
            var result = new ServiceModelResult<SaveResponse>();
            result.Model = new SaveResponse() { TypeName = nameof(Domain.Models.ProductType) };
